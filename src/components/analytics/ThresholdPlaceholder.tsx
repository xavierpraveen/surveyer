...
export default function ThresholdPlaceholder({
  ...
  return (
    <span className={`group relative inline-flex items-center ${className ?? ''}`}>
      ...
      <span className="hidden group-hover:block absolute bottom-full left-1/2 -translate-x-1/2 mb-1 bg-gray-800 text-white text-xs rounded px-2 py-1 w-56 z-50 pointer-events-none">
        {tooltip}
      </span>
    </span>
  )
